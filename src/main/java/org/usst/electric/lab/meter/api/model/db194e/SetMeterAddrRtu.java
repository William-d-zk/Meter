...
public class SetMeterAddrRtu
        extends ModbusRtuProtocol
        implements ICommand
{
    final static int SERIAL = COMMAND_SERIAL + 0x1004;

    public SetMeterAddrRtu(byte address, byte ctrl, byte[] payload)
    {
        super(address, ctrl, payload);
    }

    public SetMeterAddrRtu()
    {
    }
